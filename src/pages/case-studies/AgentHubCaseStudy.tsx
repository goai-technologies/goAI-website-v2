...
export function AgentHubCaseStudy() {
  ...
  return (
    <>
      <SEO
        title="AgentHub Automation - Case Study | goAI"
        description="How we built an AI agent automation platform that achieved 85% task automation in 3 weeks. Built with LangChain, TypeScript, and Vector DB."
        keywords="ai agents case study, automation platform, langchain, ai development"
        url="https://goai.dev/case-studies/agenthub"
      />
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
        ...
        <section className="pt-32 pb-20 px-6 relative overflow-hidden" ref={heroSection.ref}>
          ...
          <div className="fixed top-20 right-20 w-96 h-96 bg-pink-500/10 rounded-full blur-3xl animate-float"></div>
          <div className="fixed bottom-20 left-20 w-72 h-72 bg-cyan-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '-3s' }}></div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className={`max-w-4xl ${heroSection.isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
              <div className="inline-flex items-center gap-2 bg-pink-400/10 border border-pink-400/30 rounded-full px-6 py-2 mb-6">
                ...
                <span className="text-pink-400 font-semibold">AI AGENTS</span>
              </div>

              <h1 className="text-6xl md:text-7xl font-bold mb-6 leading-tight">
                <span className="gradient-text from-pink-400 to-cyan-500">AgentHub Automation</span>
              </h1>

              <p className="text-2xl text-slate-300 mb-8 leading-relaxed">
                Built an AI agent automation platform that transformed workflows, achieving 85% task automation in just 3 weeks using LangChain and vector databases.
              </p>
